    ...
    <div className="flex flex-col items-center bg-background text-foreground min-h-screen overflow-x-hidden">
      ...
      <section className="w-full py-24 lg:py-40 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
          <ScrollReveal animationClass="animate-fadeInUp" delay={100}>
          ...
          <ScrollReveal animationClass="animate-fadeInUp" delay={300}>
          ...
          <ScrollReveal animationClass="animate-fadeInUp" delay={500}>
      ...
      <section id="features" className="py-16 lg:py-24 w-full bg-card">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal animationClass="animate-fadeInUp" delay={200}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <ScrollReveal key={index} animationClass="animate-fadeInUp" delay={200 + index * 100}>
                <div className="text-center p-8 bg-background rounded-xl shadow-2xl hover:shadow-primary/20 transition-shadow duration-300 flex flex-col items-center h-full">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {stats.map((stat, index) => (
              <ScrollReveal key={index} animationClass="animate-fadeInUp" delay={200 + index * 100}>
                <div className="flex flex-col items-center p-8 bg-card rounded-xl shadow-xl hover:shadow-accent/20 transition-shadow h-full">
            ...
            <div className="bg-background p-8 md:p-12 rounded-xl shadow-2xl overflow-hidden">
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    <div>
                        ...
                        <ScrollReveal animationClass="animate-fadeInUp" delay={400}>
